...
export default function DukaHomePage() {
    const [products, setProducts] = useState<DukaProduct[]>([]);
    const [shops, setShops] = useState<DukaShop[]>([]);
    ...
    return (
        <div className="bg-background min-h-screen">
            ...
            <main>
                ...
                <QuickReorderSection products={products} />
            </main>
        </div>
    )
}
