...
interface NestHomesClientProps {
    ...
    <footer className="border-t">
        <div className="w-[94%] mx-auto py-8">
            ...
            <div className="mt-8 border-t pt-4 text-center text-sm text-muted-foreground">
                <p>&copy; 2025 NestHomes by Nest Hub. All rights reserved.</p>
            </div>
        </div>
    </footer>
);

export function NestHomesClient({ initialProperties }: NestHomesClientProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background nesthomes-theme">
      ...
      <main>
        <HeroSection />
        <FeaturedPropertiesSection properties={initialProperties} />
        <NewsSection />
      </main>
      <Footer />
    </div>
